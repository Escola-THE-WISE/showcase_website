...
function togglePasswordVisibility() {
    ...
    if (passwordField.type === "password") {
      ...
      toggleIcon.src = "/assets/img/icons/close-icon.png"; // Ícone alternativo para esconder senha
    } else {
      passwordField.type = "password";
      toggleIcon.src = "/assets/img/icons/open-icon.png"; // Ícone para mostrar senha
    }
  }
